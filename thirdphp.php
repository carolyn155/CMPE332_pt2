...
$sql = "select SessionName, SpeakerID, StartTime, EndTime, RoomLocation, SessionDay from ScheduleInformation where SessionDay = ?";
...
while ($row = $stmt->fetch()) {
	echo "<tr><td>".$row["SessionName"]."</td><td>".$row["SpeakerID"]."</td><td>".$row["StartTime"]."</td><td>".$row["EndTime"]."</td><td>".$row["RoomLocation"]."</td><td>".$row["SessionDay"]."</td></tr>";
}
